package com.alibaba.rocketmq.diagnosis.util.upsert
...
internal class UpsertStatement<Key : Any>(
    ...
    override fun prepareSQL(transaction: Transaction) = buildString {
        ...
        // sort update statement
        val updateValues = updateStatement.builderValues.toSortedMap()
    ...
    private fun onDuplicateKeyUpdate(transaction: Transaction, updateValues: Map<Column<*>, Any?>): String =
        buildString {
